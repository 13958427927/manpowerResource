<template>
  <div class="login-container">
    <el-form ref="loginForm" class="login-form" label-position="left" :model="loginForm" :rules="rules">
      ...
      <el-button :loading="loading" class="loginBtn" type="primary" @click="login">Login</el-button>
      <div class="tips">
...
export default {
  name: 'Login',
  data() {
    const phoneValid = (rule, vaule, callback) => {
      if (!validPhone(vaule)) {
        // 没通过
